...
<html>
    <head>
        ...
        <link href="<?php echo $this->config->item("base_url"); ?>css/bootstrap.css" rel='stylesheet' type='text/css' />
        ...
        <script type="text/javascript" src="<?php echo $this->config->item("base_url"); ?>js/jquery-1.11.1.min.js"></script>
        <!-- start menu -->
        <link href="<?php echo $this->config->item("base_url"); ?>css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
        <script type="text/javascript" src="<?php echo $this->config->item("base_url"); ?>js/megamenu.js"></script>
...
<!--                            <li class="active grid">
                                <a class="color8" href="index.html">Home</a>
                            </li>	-->
                            <li>
...
<!--			  	   	<select class="drop-down "> 
                ...
                <div class="header_bootm">
                    <div class="col-sm-4 span_1">
                        <div class="logo">
                            <a href="<?php echo $this->config->item("base_url"); ?>"><img src="<?php echo $this->config->item("base_url"); ?>images/logo.png" alt=""/></a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9 banner_right">
                        ...
                        <section class="slider">
                            <div class="flexslider">
                                <ul class="slides">
                                    <li><img src="<?php echo $this->config->item("base_url"); ?>images/banner.jpg" alt=""/></li>
                                    <li><img src="<?php echo $this->config->item("base_url"); ?>images/banner1.jpg" alt=""/></li>
                                </ul>
                            </div>
                        </section>
                        <!-- FlexSlider -->
                ...
                <div class="content">
                            ...
                            <div class="col-md-6 box_2">
                                <div class="section_group"> 
                                    <div class="col_1_of_2 span_1_of_2">
                                        <img src="<?php echo $this->config->item("base_url"); ?>images/pic7.jpg" class="img-responsive" alt=""/>
                                    </div>
                                    <div class="col_1_of_2 span_1_of_2">
                                        <img src="<?php echo $this->config->item("base_url"); ?>images/pic8.jpg" class="img-responsive" alt=""/>
                                    </div>
                                    <div class="clearfix"> </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="box_3">
                                    ...
                                    <div class="col_1_of_2 span_1_of_2 span_4">
                                        <div class="span_5">
                                            <img src="<?php echo $this->config->item("base_url"); ?>images/pic9.png" class="img-responsive" alt=""/>
                                        </div>
                                    </div>
                                    <div class="clearfix"> </div>
                                </div>
                    ...
                    <div class="footer_top">
                        <div class="span_of_4">
                            <div class="col-md-12 box_4">
                                <div class="span1_of_2">
                                    <h5>need help? <a href="#">contact us <span> &gt;</span> </a> </h5>
                                    <p>(or) Call us: +766-669-6778-2</p>
                                </div>
                                <div class="span1_of_2">
                                    <h5>follow us </h5>
                        ...
                        <div class="copy">
                            <p>© 2015 All Rights Reserved &copy; </p>
                        </div>
                    </div>
                </div>	
