...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                                    ...
                                    <ul class="chat-box">
                                        <li class="left clearfix">
                                            <span class="chat-img pull-left">
                                                <img src="<?php echo $this->config->item("base_url"); ?>images/1.png" alt="User" class="img-circle" />
                                            </span>
                                            <div class="chat-body">                                        
                                        ...
                                        <li class="right clearfix">
                                            <span class="chat-img pull-right">
                                                ...
                                                <img src="<?php echo $this->config->item("base_url"); ?>images/2.png" alt="User" class="img-circle" />
                                            </span>
                                        ...
                                        <li class="left clearfix">
                                            <span class="chat-img pull-left">
                                                <img src="<?php echo $this->config->item("base_url"); ?>images/3.png" alt="User" class="img-circle" />
                                            </span>
                                            <div class="chat-body clearfix">
                                        ...
                                        <li class="right clearfix">
                                            <span class="chat-img pull-right">
                                                <img src="<?php echo $this->config->item("base_url"); ?>images/4.png" alt="User" class="img-circle" />
                                            </span>
                                            <div class="chat-body clearfix">
        ...
        <!-- JQUERY SCRIPTS -->
        <script src="<?php echo $this->config->item("base_url");?>js/jquery-1.10.2.js"></script>
        <!-- BOOTSTRAP SCRIPTS -->
